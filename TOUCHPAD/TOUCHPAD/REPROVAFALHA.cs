...
namespace TOUCHPAD
{
    public partial class REPROVAFALHA : MaterialSkin.Controls.MaterialForm
    {
        ...
        private void btnReteste_Click(object sender, EventArgs e)
        {
            ...
            //Não faz sendito inserir o if da flag
            //Só avança para reteste se pressionar botão
            TOUCHPAD1 = "OK";

            TOUCHPAD formTouchPad = new TOUCHPAD();
            this.Hide();
        ...
        public void CriarLogFalha()
        {
            try
            {
                ...
                //Criar log de voz
                System.IO.StreamWriter sw2 = new StreamWriter(@"C:\TESTES_AVELL\logs_touch\Falha" + dataHoraMinuto + ".log");
