...
namespace AUDIO
{
    public partial class VALIDACONFIRMA1 : MaterialSkin.Controls.MaterialForm
    {
        public string TimeStop;

        public VALIDACONFIRMA1()
        {
            InitializeComponent();
            Interacao();
            //TimeStart();
        ...
        public void Interacao()
        {
            ...
            wplayer.URL = @"C:\TESTES_AVELL\audiofilesAlertas\LoopBackOk.mp3";
        ...
        {
            TimeStop = "stop";
            MICROFONEINT formMicrofoneInterno = new MICROFONEINT();
            this.Hide();
