...
namespace TECLADO
{
    public partial class TECLADO1 : MaterialSkin.Controls.MaterialForm
    {
        ...
        private void TECLADO1_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (tecla == 35)
            {
                btnEnd.BackColor = Color.DarkGreen;
            }
            if (tecla == 144)
            {
            ...
            //Encontrar a tecla Print Screen
            if (tecla == 44)
            {
                MessageBox.Show("Tecla44 print screen");
            }
        }
        ...
        private void timerCheck_Tick(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                && btnDel.BackColor == Color.DarkGreen && btnApos.BackColor == Color.DarkGreen && btnExc.BackColor == Color.DarkGreen && btnArrob.BackColor == Color.DarkGreen
                ...
                && btnSub.BackColor == Color.DarkGreen && btnSom.BackColor == Color.DarkGreen && btnEnd.BackColor == Color.DarkGreen && btnNuml.BackColor == Color.DarkOliveGreen
