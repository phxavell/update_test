...
namespace TECLADO
{
    public partial class TECLADO7 : MaterialSkin.Controls.MaterialForm
    {
        ...
        private void TECLADO7_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (tecla == 35)
            {
                btnPower.BackColor = Color.Orange;
            }
            if (tecla == 111)
            {
        ...
        private void timerCheck_Tick(object sender, EventArgs e)
        {
            try
            {
                ...
                && btnF12.BackColor == Color.DarkGreen && btnPrint.BackColor == Color.DarkOliveGreen
                ...
                && btnSub.BackColor == Color.DarkGreen && btnNuml.BackColor == Color.DarkOliveGreen && btnPower.BackColor == Color.Orange && btnDiv.BackColor == Color.DarkGreen
