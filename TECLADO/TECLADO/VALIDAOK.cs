...
namespace TECLADO
{
    public partial class VALIDAOK : MaterialSkin.Controls.MaterialForm
    {
        ...
        public void Interacao()
        {
            ...
            wplayer.URL = @"C:\TESTES_AVELL\audiofilesAlertas\TecladoOk.mp3";
        ...
        public void CriarLogOK_MySQL()
        {
            try
            {
                ...
                const string Teclado = @"C:\TESTES_AVELL\MySqlData\Teclado.txt";
        ...
        public void GerarLogIndividual()
        {
            try
            {
                ...
                var dataHoraMinutoOK = DateTime.Now.ToString("dd-MM-yyyy-HH:mm:s:s");
                const string Drivers = @"C:\TESTES_AVELL\logs_teclado\Teclado.log";
        ...
        public void InsertAvellWeb()
        {
            ...
            foreach (ManagementObject obj in collection)
            {
                ...
                //Gera Log de OK para o MySql
                var dataHoraMinutoOK = DateTime.Now.ToString("dd-MM-yyyy-HH:mm:s:s");
                string Furmark = "C:\\TESTES_AVELL\\MySqlData\\" + NomeArquivo + "\\Teclado_OK.txt";
            ...
            try
            {
                ...
                foreach (ManagementObject getserial in MOS1.Get())
                {
                    ...
                    String DadosFirebase1 = "Teclado OK!:" + dataHoraMinuto;
