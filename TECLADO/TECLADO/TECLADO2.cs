...
namespace TECLADO
{
    public partial class TECLADO2 : MaterialSkin.Controls.MaterialForm
    {
        ...
        private void TECLADO2_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (tecla == 13)
            {
                ...
                btnEnterComp.BackColor = Color.DarkGreen;
            ...
            if (tecla == 193)
            {
                btnCtrl2.BackColor = Color.DarkGreen;
            }
            if (tecla == 37)
            {
        ...
        private void btnTeclado3_Click(object sender, EventArgs e)
        {
            TECLADO3 novaform = new TECLADO3();
            this.Hide();
            novaform.Show();
        }
        ...
        private void timerCheck_Tick(object sender, EventArgs e)
        {
            try
            {
                ...
                && btnF12.BackColor == Color.DarkGreen && btnPrint.BackColor == Color.DarkOliveGreen && btnPause.BackColor == Color.DarkGreen
                ...
                && btnV.BackColor == Color.DarkGreen && btnB.BackColor == Color.DarkGreen && btnN.BackColor == Color.DarkGreen && btnM.BackColor == Color.DarkGreen
                && btnMenor.BackColor == Color.DarkGreen && btnMaior.BackColor == Color.DarkGreen && btnDoisP.BackColor == Color.DarkGreen && btnCima.BackColor == Color.DarkGreen
                && btnCtrl.BackColor == Color.DarkGreen && btnFN.BackColor == Color.DarkGreen && btnCtrl2.BackColor == Color.DarkOliveGreen && btnFN.BackColor == Color.DarkGreen
                && btnWindow.BackColor == Color.DarkGreen && btnAlt.BackColor == Color.DarkGreen && btnAlt2.BackColor == Color.DarkOliveGreen && btnSpace.BackColor == Color.DarkGreen
                && btnList.BackColor == Color.DarkGreen && btnEsq.BackColor == Color.DarkGreen && btnBaixo.BackColor == Color.DarkGreen && btnDir.BackColor == Color.DarkGreen
                && btnSub.BackColor == Color.DarkGreen && btnNuml.BackColor == Color.DarkOliveGreen && btnEnd.BackColor == Color.DarkGreen && btnDiv.BackColor == Color.DarkGreen
                && btnMult.BackColor == Color.DarkGreen && btnSom.BackColor == Color.DarkGreen && btn7.BackColor == Color.DarkGreen && btn8.BackColor == Color.DarkGreen
                && btn9.BackColor == Color.DarkGreen && btn7.BackColor == Color.DarkGreen && btn8.BackColor == Color.DarkGreen && btn9.BackColor == Color.DarkGreen
                && btn4.BackColor == Color.DarkGreen && btn5.BackColor == Color.DarkGreen && btn6.BackColor == Color.DarkGreen && btn1.BackColor == Color.DarkGreen
                && btn2.BackColor == Color.DarkGreen && btn3.BackColor == Color.DarkGreen && btn0.BackColor == Color.DarkGreen && btnDel2.BackColor == Color.DarkGreen)
                {
                    ValidaTeclado = "OK";
