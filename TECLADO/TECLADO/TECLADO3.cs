...
namespace TECLADO
{
    public partial class TECLADO3 : MaterialSkin.Controls.MaterialForm
    {
        ...
        private void TECLADO3_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (tecla == 194)
            {
                btnPonto.BackColor = Color.DarkGreen;
            }
            if (tecla == 110)
            {
        ...
        private void timerCheck_Tick(object sender, EventArgs e)
        {
            try
            {
                ...
                && btn3.BackColor == Color.DarkGreen && btn0.BackColor == Color.DarkGreen && btnPonto.BackColor == Color.DarkGreen && btnDel2.BackColor == Color.DarkGreen
                )
                {
                    ValidaTeclado = "OK";
