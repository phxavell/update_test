...
namespace TECLADO
{
    public partial class TECLADO4 : MaterialSkin.Controls.MaterialForm
    {
        ...
        public void TimeStart()//Não ativado no momento
        {
        ...
        public void DesabiltarTab()
        {
            ...
            btnContBa.TabStop = false;
            btnCtrl2.TabStop = false;
            btnEnterComp.TabStop = false;
        }

        private void TECLADO4_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (tecla == 46)
            {
                ...
                btnPrint.BackColor = Color.DarkOliveGreen;
            }
            if (tecla == 192)
            {
                btnInsert.BackColor = Color.DarkOliveGreen;
                btnApos.BackColor = Color.DarkOliveGreen;
            }
            if (tecla == 49)
            {
            ...
            if (tecla == 109)
            {
                btnSub.BackColor = Color.DarkGreen;
            }
            if (tecla == 107)
            {
                btnSom.BackColor = Color.DarkGreen;
            }
            if (tecla == 144)
            {
            ...
            if (tecla == 226)
            {
                btnContBa.BackColor = Color.DarkGreen;
            }
        }

        private void timerCheck_Tick(object sender, EventArgs e)
        {
            //Adicionar no timer o Stop
            try
            {
                ...
                && btnF12.BackColor == Color.DarkGreen && btnPrint.BackColor == Color.DarkOliveGreen && btnPause.BackColor == Color.DarkGreen && btnPause.BackColor == Color.DarkGreen
                && btnDel.BackColor == Color.DarkGreen && btnApos.BackColor == Color.DarkOliveGreen && btnExc.BackColor == Color.DarkGreen && btnArrob.BackColor == Color.DarkGreen
                ...
                && btnTio.BackColor == Color.DarkGreen && btnEnter.BackColor == Color.DarkGreen && btnShift.BackColor == Color.DarkGreen && btnShift.BackColor == Color.DarkGreen
                && btnZ.BackColor == Color.DarkGreen && btnX.BackColor == Color.DarkGreen && btnC.BackColor == Color.DarkGreen && btnV.BackColor == Color.DarkGreen
                && btnB.BackColor == Color.DarkGreen && btnN.BackColor == Color.DarkGreen && btnM.BackColor == Color.DarkGreen && btnMenor.BackColor == Color.DarkGreen
                && btnMaior.BackColor == Color.DarkGreen && btnDoisP.BackColor == Color.DarkGreen && btnShift2.BackColor == Color.DarkOliveGreen && btnCima.BackColor == Color.DarkGreen
                && btnCtrl.BackColor == Color.DarkGreen && btnFN.BackColor == Color.DarkGreen && btnFN.BackColor == Color.DarkGreen && btnWindow.BackColor == Color.DarkGreen
                && btnAlt.BackColor == Color.DarkGreen && btnAlt2.BackColor == Color.DarkOliveGreen && btnSpace.BackColor == Color.DarkGreen && btnList.BackColor == Color.DarkGreen
                && btnInt.BackColor == Color.DarkGreen && btnEsq.BackColor == Color.DarkGreen && btnBaixo.BackColor == Color.DarkGreen && btnDir.BackColor == Color.DarkGreen
                && btnSub.BackColor == Color.DarkGreen && btnSom.BackColor == Color.DarkGreen && btnInsert.BackColor == Color.DarkOliveGreen && btnNuml.BackColor == Color.DarkOliveGreen
                && btnDiv.BackColor == Color.DarkGreen && btnMult.BackColor == Color.DarkGreen && btn7.BackColor == Color.DarkGreen && btn8.BackColor == Color.DarkGreen
                && btn9.BackColor == Color.DarkGreen && btn4.BackColor == Color.DarkGreen && btn5.BackColor == Color.DarkGreen && btn6.BackColor == Color.DarkGreen
                && btn1.BackColor == Color.DarkGreen && btn2.BackColor == Color.DarkGreen && btn3.BackColor == Color.DarkGreen && btn0.BackColor == Color.DarkGreen
                && btnDel2.BackColor == Color.DarkGreen && btnContBa.BackColor == Color.DarkGreen)
                {
                    ValidaTeclado = "OK";
            ...
            {
                MessageBox.Show("Falha ao testar teclas Teste Teclado" + ex);
            }
        }
