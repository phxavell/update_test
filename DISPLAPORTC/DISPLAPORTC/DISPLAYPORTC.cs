...
{
    public partial class DISPLAYPORTC : MaterialSkin.Controls.MaterialForm
    {
        ...
        //Ajustar o Audio files do DisplayPort
            ...
            relogio.Tick += delegate {
                ...
                if (tempo == 0)
                {
                    ...
                    if (DISPLAYPORTOK != "OK")
                    {
                        ...
                        DPORTAUDIO formDISPORTAudio = new DPORTAUDIO();
                        this.Hide();
            ...
            if (DISPLAYPORTOK != "FALHA")
            {
                ...
                relogio.Tick += delegate {
                    ...
                    if (tempo == 0)
                    {
                        ...
                        DPORTDESCONECTADO formDPPORTDesconectado = new DPORTDESCONECTADO();
                        this.Hide();
